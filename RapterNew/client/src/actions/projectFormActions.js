...
const CHANGE_ORG_DELETED_STATUS ='CHANGE_ORG_DELETED_STATUS'
...
const actions = {
    ...
    changeOrgDeletedStatus: (payload) => ({
        type: CHANGE_ORG_DELETED_STATUS,
        data: payload
    }),
...
export const changeOrgDeletedStatus =() => (dispatch)=>{
    dispatch(actions.changeOrgDeletedStatus());
}
