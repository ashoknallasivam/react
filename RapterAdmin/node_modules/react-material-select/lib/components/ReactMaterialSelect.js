...
var ReactMaterialSelect = function (_Component) {
    ...
    function ReactMaterialSelect(props) {
        ...
        _this.handleSetSelect = _this.handleSetSelect.bind(_this);
    ...
    _createClass(ReactMaterialSelect, [{
        ...
        key: 'handleSetSelect',
        value: function handleSetSelect(label, value) {
            this.changeState({
                isOpen: false,
                isSelected: true,
                selected: {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'i',
                    { onClick: this.handleToggleSelect, className: 'rms-caret' },
                    'arrow_drop_down'
                ),
                this.state.isOpen && _react2.default.createElement(
                    'ul',
                    { ref: 'rmsList', className: 'rms-list', style: { top: this.state.rmsListTopValue } },
...
ReactMaterialSelect.propTypes = {
    ...
    resetLabel: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.bool]),
