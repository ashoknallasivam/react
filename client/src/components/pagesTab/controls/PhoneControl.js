	...
	render() {
		return (
			<Collapsible accordion={false}>
				<CollapsibleItem header="Phone" icon="keyboard_arrow_down">
					<div>
						<h5><b>Phone Configuration</b></h5>
					</div>
					<div>
						<Input s={12} label="Element type" id="type" name="type" type="text" value="phone" disabled required />
					</div>
					<div>
						<Input s={12} className="mb-0" label="Name *" id="name" name="name" type="text" value="" required autoComplete='off'
						...
						<Collapsible accordion={false}>
							<CollapsibleItem header='options' icon="keyboard_arrow_down">
								...
								<fieldset><legend><b>Validation</b></legend>
									...
									<div>
										<Input s={12} className="mb-0" name="patternValMsg" type="text" value="Pattern validation message" disabled required />
