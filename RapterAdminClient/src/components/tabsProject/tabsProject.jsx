...
class TabsProject extends Component {
    ...
    editStudyConfigValidation = () => {
        ...
        if (sum > 1)
            this.setState({ cumulativeRatio: true });
        else
            this.setState({ cumulativeRatio: false });
    }
    ...
    getEnrollmentTargetData = () => {
        ...
        if (this.props.ApplicationMode == "CREATE") {
            this.props.enrollmentTargetData && this.props.enrollmentTargetData.map(item => {
            ...
            enrollmentData = [];
            this.props.enrollmentTargetList.map(item => {
                if (item.orgId == this.props.selectedCurrentLTO) {
                    enrollmentData.push(item);
                }
            })
                    ...
                    <Tabs>
                        ...
                        <TabPanel>
                            ...
                            <StudyConfig
                                ...
                                cumulativeRatio={this.state.cumulativeRatio} />
                        </TabPanel>
                        <TabPanel>
