...
class ReactGrid extends Component {
    ...
    render() {
        return (
            <Fragment>
                <div className="ag-theme-balham pl-2" style={{ "height": this.props.gridColData.gridHeight + "vh", "width": this.props.gridColData.gridWidth + "vh" }}>
                    <AgGridReact
                        ...
                        rowDeselection={true}
                        defaultColDef={(this.props.gridColData.defaultColDef && this.props.ApplicationMode !== 'VIEW') ? this.props.gridColData.defaultColDef : null}
