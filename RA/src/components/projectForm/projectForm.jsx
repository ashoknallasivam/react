        ...
        return (
            <Row className="project-form">
                <div className='col s12 m12 l12 xl12 mt-1'>
                    <Input className='mt-0's={12} m={4} l={4} xl={4} label="Project Name" onChange={this.handleTenantInput} onBlur={this.UpdateTenant} value={this.state.tenantName} readOnly={this.props.ApplicationMode == 'VIEW' ? true : false}/>
                ...
                <div className='col s12 m12 l12 xl12 mt-2'>
			        <div className='col s12 m6 l6 xl6'>
                        <label className="orgLabel" >Organization</label>
                            <select check={this.state.selectedDropdownOrg} className="browser-default col input-field s12 m6 l6 x6 mt-5" onChange={this.handleOrgDropdown} value={this.state.selectedDropdownOrg} disabled={ this.props.organizations == ''? true:false}>
                    ...
                    >
                        ...
                        >
                            <Input s={12} m={12} l={12} xl={12} onChange={this.updateOrganizationName} name="orgName" 
                ...
                </div>
                {
                    ...
                    this.props.organizations.length > 0 ? 
                        <div className='col s12 m6 l6 xl6'>
                                ...
                                <select check={this.state.selectedDropdownLoc} className="browser-default col input-field s12 m6 l6 xl6 mt-5" onChange={this.handleLocDropdown} value={this.state.selectedDropdownLoc} disabled={ this.props.locations == ''? true:false}>
				            ...
				            <Modal
                                ...
                                <Input s={12} m={6} l={6} xl={6} onChange={this.updateLocationName} 
