    ...
    <div className='col s12 m12 l12 xl12 pl-0 '>
        ...
        {props.ApplicationMode !== 'VIEW' ?
            <div className='col s12 m3 l3 xl3 pr-0 MapcheckboxLTo'>
                    ...
                    label={props.selectedCurrentLTO == '' ? 'Mapping to Organization' : 'Check for map to Location'} 
                    />
            </div>: null
        }
    </div>
<div>
    <div className='mb-2 col s4'>
        ...
        >
            ...
            <div className="modalButton mb-2">
                <Button className='btn_secondary otherButtonAddDetUpt' onClick={props.DeleteRole} >Delete</Button>
                <button className="btn btn_secondary waves-effect waves-light btn-flat modal-action modal-close otherButtonAddDetUpt">Cancel</button>
                </div>
        </Modal>
            </div>
        </form>
